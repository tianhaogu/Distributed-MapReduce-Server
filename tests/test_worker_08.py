...
def manager_message_generator(mock_socket):
    ...
    # Simulate manager creating file reduce1
...
def test_worker_08_map_group_reduce(mocker):
    ...
    with Path("tmp/test_worker_08/file01").open(encoding='utf-8') as infile:
        mapout01 = infile.readlines()
    with Path("tmp/test_worker_08/file02").open(encoding='utf-8') as infile:
    ...
    with Path("tmp/test_worker_08/group.out").open(encoding='utf-8') as infile:
    ...
    reduce01 = Path('tmp/test_worker_08/output/reduce01')
